...
SELECT SUM(Population) AS total_population_below_10000 
FROM City 
...
WHERE co.Region = (SELECT Region FROM Country co JOIN City c ON co.Capital = c.Id WHERE c.Name = 'Yaren');
#
#
...
WHERE co.Region = (SELECT Region FROM Country co JOIN City c ON co.Capital = c.Id WHERE c.Name = 'Riga');
#
#
